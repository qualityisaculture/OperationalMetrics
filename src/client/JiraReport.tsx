...
import { JiraIssueWithAggregated, JiraReportState } from "./JiraReport/types";
import {
  calculateAggregatedValues,
  processWorkstreamData,
} from "./JiraReport/utils";
import {
  getProjectColumns,
} from "./JiraReport/components/tables/projectColumns";
import {
  getIssueColumns,
} from "./JiraReport/components/tables/issueColumns";
import {
  ReloadOutlined,
  ProjectOutlined,
  InfoCircleOutlined,
...
export default class JiraReport extends React.Component<Props, JiraReportState> {
  ...
  render() {
    ...
    const issueColumns = getIssueColumns(
      ...
      currentIssues,
      projectIssues,
      this.getWorkstreamDataCellSpan
    );
